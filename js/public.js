...
$(function () {
  ...
  $('#maylike').each (function () {
    var $div = $(this).find ('div.products');

    $(this).find ('>div>div>a').click (function () {
      var $tmp = null;
    ...
    if ($(this).find ('>div>div>a').is(':visible')) {
      $tmp = $div.find ('>*').last ();
      $tmp.clone (true).prependTo ($div);
      $tmp.remove ();
    }
  ...
  $('#content .container .l .imgs .img').each (function () {
    $(this).click (function () {

      var src = $(this).find ('img').attr ('src');
      $(this).parent ().prev ().find ('img').attr ('src', src);
      $(this).parent ().prev ().imgLiquid ();
    });
  });
  $('#content .container .c .tab a').each (function () {
    $(this).click (function () {
